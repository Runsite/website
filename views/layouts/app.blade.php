		...
		<div class="container">
			<div class="row">
						...
						<nav class="navbar navbar-expand-lg navbar-light bg-white pl-0">
							...
							<div class="collapse navbar-collapse" id="mainNav" aria-label="Навігація по сайту">
								<ul class="navbar-nav ml-auto">
									...
									<li class="nav-item">
										<a class="nav-link" href="#" rel="prefetch">Особливості</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#" rel="prefetch">Наші клієнти</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="#" rel="prefetch">Контакти</a>
									</li>
								</ul>
							</div>
						</nav>
				...
				<div class="col-lg-2 pl-0 hidden d-none d-lg-block">
					<a href="#" class="btn btn-dark btn-lg btn-block btn-header js-btn-cursor-spot js-btn-cursor-spot-light" rel="prefetch"><i class="fa fa-edit"></i> Бриф</a>
				</div>
			</div>
		</div>
	</header>
